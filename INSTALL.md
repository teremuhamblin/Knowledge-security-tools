🟩 1. README.md — Dossier Perso/
(à placer dans Knowledge-security-tools/Perso/README.md)

`markdown

🧰 Scripts Perso — Knowledge Security Tools

Ce dossier regroupe trois scripts spécialisés permettant d’installer, configurer et provisionner des environnements complets dédiés à l’OSINT, à la Forensic et aux outils complémentaires.  
...
1. 🕵️ labs.sh — Installation des environnements OSINT
...
2. 🧪 forensics.sh — Environnement Forensic & Blue Team
...
3. 🛠️ extras.sh — Outils complémentaires & utilitaires
